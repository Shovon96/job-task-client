  ...
  return (
    <Navbar onMenuOpenChange={setIsMenuOpen} className='bg-white shadow-lg'>
      <NavbarContent>
        ...
        />
        <NavbarBrand>
          <img className='h-10 w-52 md:h-14 md:w-72' src="https://media.discordapp.net/attachments/1177886803424976896/1187250535628288070/logo.png?ex=65963439&is=6583bf39&hm=8b8deb55d58d4524e9a61c4225be0c0b9175c881ffdcf746d0793633b89a79a0&=&format=webp&quality=lossless" alt="" />
        </NavbarBrand>
      </NavbarContent>
